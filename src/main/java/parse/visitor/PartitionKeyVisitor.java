...
public final class PartitionKeyVisitor implements SQLASTVisitor {
    ...
    /**
     * @return null for statement not table meta readFromChannel
     */
    ...
    private void addIntoColumnValueIndex(Map<Object, Set<Pair<Expression, ASTNode>>> valMap,
        ...
        if (exprSet == null) {
            ...
            exprSet = new LinkedHashSet<Pair<Expression, ASTNode>>();
    ...
    public void visit(BetweenAndExpression node) {
        ...
        if (verdictColumn && !node.isNot() && fst instanceof Identifier) {
            ...
            if (isRuledColumn(table, col.getIdTextUpUnescape())) {
                ...
                boolean flag = true;
                if (e1.toString().length() == TIMESTAMP_LENGTH || e1.toString().length() == DATE_LENGTH) {
                    try {
                        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
                        Date first = sdf.parse(e1.toString());
                        Date second = sdf.parse(e2.toString());
...
//                        e.printStackTrace();// TODO Auto-generated catch block
                    ...
                    if (flag && e1 != Expression.UNEVALUATABLE && e2 != Expression.UNEVALUATABLE && e1 != null && e2 != null) {


                    }

                } else if (e1 != Expression.UNEVALUATABLE && e2 != Expression.UNEVALUATABLE && e1 != null && e2 != null) {
                    if (compareEvaluatedValue(e1, e2)) {
                        addColumnValue(table, col.getIdTextUpUnescape(), e1, node, null);
                    }
                }
